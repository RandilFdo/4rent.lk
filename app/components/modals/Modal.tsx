      ...
      <>
         <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
            <div className="relative w-full sm:w-11/12 md:w-4/6 lg:w-3/6 xl:w-2/5 my-2 sm:my-4 md:my-6 mx-auto h-full lg:h-auto md:h-auto max-h-[95vh]">
               ...
               >
                  <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white dark:bg-gray-800 outline-none focus:outline-none max-h-[95vh] overflow-y-auto">
                     {/* HEADER */}
